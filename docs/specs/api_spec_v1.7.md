# kabuhandan_hojo API Spec v1.7

## 1. scope

この版は v1.6 の API 契約を累積継承し、次を追加・更新する。
...
v1.6 の最小AI縦スライスと、legacy multi-mode stock AI review、Prompt Registry / Prompt Builder、mode別Structured Outputs、Web検索制御、JSON parse救済、ChatGPT手動投入用プロンプト生成は引き続き有効である。ただし、legacy機能はstock-review経路の契約であり、canonical個別銘柄AI経路には継承しない。
