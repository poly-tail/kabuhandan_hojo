# kabuhandan_hojo API Spec v2.1

## 1. scope

この版は v2.0 の API 契約を累積継承し、legacy軽量スキャンの構造化response境界を次のとおり更新する。
...
|---|---|---|---|---|
| `scanner` | `OPENAI_MODEL_SCANNER` | `OPENAI_REASONING_SCANNER` | `optional` | Base, 0, 1, 2 summary, 3 summary, 9, 13 short, 14 short。stock outputは30項目未満の軽量schema |
