...
| 種別 | 現在版 | 正本 | 適用日 |
|---|---:|---|---|
| 要件仕様 | v1.6 | `docs/requirements/requirements_v1.6.md` | 2026-08-18 |
| API仕様 | v1.9 | `docs/specs/api_spec_v1.9.md` | 2026-08-18 |
| 画面仕様 | v2.1 | `docs/screen_specs/screen_spec_v2.1.md` | 2026-08-18 |

この3版は同じ変更単位 `SC-2026-08-18-01` を表します。どれか1つだけを旧版へ戻して運用することは想定しません。

## 3. SC-2026-08-18-01 — 銘柄検索から保有入力への導線とJ-Quants code alias
...
### 3.4 portfolio identifier alias
...
## 4. SC-2026-08-17-04 — legacy stock-review quota・usage・概算額
...
## 5. SC-2026-08-17-03 — canonical AI安全性・保存結果分離・loopback既定・prompt 2026.08.18
...
## 6. SC-2026-08-17-02 — canonical AI回答保存・大型表示・prompt v2026.08.17
...
## 7. SC-2026-08-17-01 — 個別銘柄AI最小縦スライスと定型prompt最小統合
...
直前baselineの完全な内容は各versioned fileに残します。新baselineはcanonical AIの安全性・保存失敗処理とlegacy usage契約を維持したまま、検索からPortfolio入力への安全な導線を追加したものです。
