...
| 種別 | 現在版 | 正本 | 適用日 |
|---|---:|---|---|
| 要件仕様 | v1.2 | `docs/requirements/requirements_v1.2.md` | 2026-08-17 |
| API仕様 | v1.5 | `docs/specs/api_spec_v1.5.md` | 2026-08-17 |
| 画面仕様 | v1.7 | `docs/screen_specs/screen_spec_v1.7.md` | 2026-08-17 |

この3版は同じ変更単位 `SC-2026-08-17-01` を表します。どれか1つだけを旧版へ戻して運用することは想定しません。

## 3. SC-2026-08-17-01 — 個別銘柄AI最小縦スライスと定型prompt最小統合
...
| 適用日 | 要件 | API | 画面 | 主な範囲 |
|---|---:|---:|---:|---|
| 2026-06-15 | v1.1 | v1.4 | v1.6 | multi-mode Portfolio AI、Prompt Registry / Builder、Web検索、Structured Outputs、mock/cache/history |
